...
(function($, undefined) {
  ...
  var base = $.support.dynamicBaseTag ? {
    ...
    element: ($base.length ? $base : $("<base>", { href: documentBase.hrefNoHash })
      .prependTo($head)),
...
--------------------------------------*/
      ...
      $.ajax({
        ...
        success: function(html, textStatus, xhr) {
          ...
          if (!$.support.dynamicBaseTag) {
            ...
            page.find("[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]")
              .each(function() {
  ...
  $.mobile.changePage = function(toPage, options) {
    ...
    var newPageTitle = (!active) ? pageTitle : toPage.jqmData("title") || toPage.children(":jqmData(role='header')")
      .find(".ui-title")
      .getEncodedText();
    ...
    $(":jqmData(role='header'), :jqmData(role='footer'), :jqmData(role='content')", this)
      .each(function() {
        ...
        if (role === "header" || role === "footer") {
          ...
          leftbtn = leftbtn || $headeranchors.eq(0)
            .not(".ui-btn-right")
  ...
  $.widget("mobile.collapsible", $.mobile.widget, {
    ...
    _create: function() {
      ...
      var $el = this.element,
        ...
        collapsibleContent = collapsible.wrapInner("<div class='ui-collapsible-content'></div>")
          .find(".ui-collapsible-content"),
        collapsibleSet = $el.closest(":jqmData(role='collapsible-set')")
          .addClass("ui-collapsible-set");

      // Replace collapsibleHeading if it's a legend
      if (collapsibleHeading.is("legend")) {
        collapsibleHeading = $("<div role='heading'>" + collapsibleHeading.html() + "</div>")
      ...
      collapsible
        .bind("expand collapse", function(event) {
          if (!event.isDefaultPrevented()) {
            ...
            collapsibleContent.toggleClass("ui-collapsible-content-collapsed", isCollapse)
      ...
      for(i = 0; i < len; i++) {
        ...
        if (img.length) {
          ...
          $(this._findFirstElementByTagName(img[0].parentNode, "parentNode", "li", "LI"))
            .addClass(img.is(".ui-li-icon") ? "ui-li-has-icon" : "ui-li-has-thumb");
        }
      }
    },
  ...
  $.widget("mobile.checkboxradio", $.mobile.widget, {
    ...
    _create: function() {
      var self = this,
        ...
        // filter works though.
        label = input.closest("form,fieldset,:jqmData(role='page')")
          .find("label")
...
(function($, undefined) {
  ...
  $.widget("mobile.slider", $.mobile.widget, {
    ...
    _create: function() {
      ...
      if (cType == "select") {
        ...
        control.find("option").each(function(i) {
          ...
          $("<span class='ui-slider-label ui-slider-label-" + side + theme + " ui-btn-corner-" + corners + "' role='img'>" + $(this)
            .getEncodedText() + "</span>")
            .prependTo(handle);
        });
    ...
    refresh: function(val, isfromControl, preventInputUpdate) {
      ...
      this.handle.attr({
        "aria-valuenow": cType === "input" ? newval : control.find("option")
          .eq(newval)
          .attr("value"),
        "aria-valuetext": cType === "input" ? newval : control.find("option")
          .eq(newval)
          .getEncodedText(),
  ...
  $.widget("mobile.textinput", $.mobile.widget, {
    ...
    _create: function() {
      ...
      if (input.is("[type='search'],:jqmData(type='search')")) {
        ...
        focusedEl = input.wrap("<div class='ui-input-search ui-shadow-inset ui-btn-corner-all ui-btn-shadow ui-icon-searchfield" + themeclass + "'></div>")
          .parent();
    ...
    $(document).bind({
      ...
      "vmouseout blur": function(event) {
        ...
        if (btn) {
          $btn = $(btn);
          theme = $btn.attr("data-" + $.mobile.ns + "theme");
          $btn.removeClass("ui-btn-hover-" + theme + " ui-btn-down-" + theme)
  ...
  $.fn.controlgroup = function(options) {
    ...
    return this.each(function() {
      ...
      if (groupheading.length) {
        ...
        $("<div role='heading' class='ui-controlgroup-label'>" + groupheading.html() + "</div>")
    ...
    if ($.support.touchOverflow && $.mobile.touchOverflowEnabled) {
      ...
      if ($target.is(":jqmData(role='page')")) {
        ...
        $target.each(function() {
          var $page = $(this),
            $fixies = $page.find(":jqmData(role='header'), :jqmData(role='footer')")
              .filter(":jqmData(position='fixed')"),
